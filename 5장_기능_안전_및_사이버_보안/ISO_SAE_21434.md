...
> **의료 로봇 관점**: ISO/SAE 21434의 TARA(Threat Analysis and Risk Assessment)는 수술 로봇의 OTA 업데이트 채널, 원격 진단 포트, 무선 통신 인터페이스에 대한 위협을 체계적으로 분석하는 도구입니다. CAL(Cybersecurity Assurance Level) 3~4가 요구되는 기능은 침투 테스트와 코드 리뷰가 필수이며, `TLS_PKI.md`의 mTLS, `Secure_Boot.md`의 Chain of Trust가 이를 구현하는 기술입니다. UNECE R155의 CSMS는 21434의 프로세스를 조직 수준으로 확장한 것으로, `UNECE_R155_R156.md`와 연계하여 읽으면 전체 사이버 보안 체계를 이해할 수 있습니다.
